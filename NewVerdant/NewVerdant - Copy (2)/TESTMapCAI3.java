...
public class TESTMapCAI3 extends Map{
    ...
    public static void main(String args[]){
        ...
        SpawnController spC = new StandardPlayerController( chase );
        int[] bk = spC.getKeys();
        bk[0] = KeyEvent.VK_U;
        bk[1] = KeyEvent.VK_J;
        bk[2] = KeyEvent.VK_H;
        bk[3] = KeyEvent.VK_K;
        spC.changeKeys(bk);
        PlayerFactory chasePF = new ChasePlayerFactory(20,20,map,spC);
        map.addPlayer(chasePF.playerSpawn());
        map.addPlayerFactory(chasePF);
        ...
        sp.changeKeys(bk);
        PlayerFactory mrMagicPF = new MrButchPlayerFactory(800,20,map,sp);
