//JUST A TEST. Expected output is a bunch of red boxes slowly falling and rotating, if fallen too far, will reinstantiate
import javax.swing.*;
import java.util.*;
import java.awt.*;
...
public class TESTMapVHCM3 extends Map
{
    static Map map;
    static Map mapper;
    ...
    private static void addSpawnRandTestFunc(int x){
        for(int i =0;i!=x;i++){
            map.addSpawn(new TESTSpawnVHCMExample2((int)(Math.random()*500+250),(int)(
